 ...
 <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select name="user_type" class="form-control">
            <option value="titulado">Usuario Titulado</option>
            <option value="director">Usuario Director de Carrera</option>
            <option value="admin">Usuario Administrador de Carrera</option>
        </select>
    </div>
    <div class="mb-3">
